...
export default class DispensaryPage {
  ...
  /**
   * @Test1 This method verifies that tooltip has the expected text.
   *
   * @description Navigate to the dispensary module and hover over the signout button.
   * Verify the text in tooltip is same as expected
   */
